...
const Features = () => {
  return (
    <div className="w-full px-10 lg:px-20 py-4 flex flex-col lg:flex-row gap-[20px] select-none">
      <div className="rounded-lg p-4 py-2 cursor-pointer w-[413px] h-[120px] border border-gray-300 hover:border-blue-700 duration-300 transition hover:-translate-y-1 flex flex-row">
        <div className="mt-5">
