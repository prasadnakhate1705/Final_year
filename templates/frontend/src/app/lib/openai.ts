        ...
        const response = await openAi.createChatCompletion({
            ...
            messages: [
                ...
                },
                {
                    ...
                    role: 'user',
                    content: `we have a ${model_text} algorithm generated image for tuberulosis chest x-ray. Write the technical explainations for results generated by the this model in 3 short points with each point having 10 words only also tell that theae are the regions highlighted by the LIME explainer whivh helps in determining the model the influentioal partrs.`
                }
            ] 
        })
